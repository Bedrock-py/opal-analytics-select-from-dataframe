...
setup(
    name='opals.select-from-dataframe',
    ...
    description='Select a subset of rows or columns from a dataframe based on indices, (column) names, or a conditional statement.',
    ...
    author_email='christine.herlihy@gtri.gatech.edu',
    ...
    packages=['opals.select-from-dataframe'],
